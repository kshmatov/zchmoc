...
Стек: **Tauri 2** (десктоп) + **SvelteKit** (интерфейс) + **TypeScript** + **CodeMirror 6** (редактор кода и подсветка примеров) + **Chez Scheme** (исполнитель кода: WASM для базы, sidecar для треков-проектов).
